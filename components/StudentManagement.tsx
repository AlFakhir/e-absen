      ...
      <div className="flex flex-col xl:flex-row xl:items-end justify-between gap-6">
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          <motion.button 
            ...
            className="flex items-center gap-2 bg-slate-900 hover:bg-slate-800 disabled:opacity-50 disabled:cursor-not-allowed text-white px-7 py-3.5 rounded-2xl font-black shadow-xl shadow-slate-900/10 transition-all text-[11px] uppercase tracking-widest"
          >
            <UserPlus size={18} />
            Tambah Siswa
          </motion.button>
            ...
            >
              ...
              <div className="p-10 flex flex-col items-center gap-10 bg-slate-50/30">
                ...
                <div ref={cardRef} className="w-[340px] h-[520px] bg-white rounded-3xl shadow-2xl border border-slate-200 overflow-hidden relative flex flex-col">
                  <div className="h-32 bg-slate-900 p-6 flex items-center gap-4 text-white relative overflow-hidden shrink-0">
                    ...
                    <div className="z-10 overflow-hidden">
                      <h4 className="text-[10px] font-black leading-none uppercase tracking-[0.2em] text-teal-400 mb-1.5">KARTU PELAJAR</h4>
                  ...
                  <div className="flex-1 flex flex-col items-center pt-12 px-8 text-center bg-white">
                    ...
                    <h2 className="text-2xl font-black text-slate-900 leading-tight mb-1 uppercase tracking-tight">{selectedStudent.name}</h2>
                    <p className="text-teal-600 font-black text-[10px] mb-10 uppercase tracking-[0.3em]">{selectedStudent.className}</p>
                    
                    <div className="w-full space-y-4 mb-6">
                      <div className="text-center border-b border-slate-100 pb-3">
                        <p className="text-[9px] font-black text-slate-300 uppercase tracking-widest mb-1">NISN / ID SISWA</p>
                        <p className="text-xl font-black text-slate-900 tracking-[0.2em]">{selectedStudent.studentId}</p>
                      </div>
                    </div>
